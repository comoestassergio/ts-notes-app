...
export function NoteList ({ availableTags, notes, handleDelete, handleUpdate }: NoteListProps) {
...
function EditTagsModal ({ availableTags, handleClose, show, handleDelete, handleUpdate }: EditTagsModalProps) {
            ...
            <Form>
                <Stack gap={2}>
                    {availableTags.map(tag => (
                        <Row key={tag.id}>
                            <Col>
                                <Form.Control onChange={(e) => handleUpdate(tag.id, e.target.value)} type='text' defaultValue={tag.label} />
                            </Col>
                            <Col xs='auto'>
                                <Button onClick={() => handleDelete(tag.id)} variant='outline-danger'>&times;</Button>
                            </Col>
                        </Row>
                    ))}
                </Stack>
